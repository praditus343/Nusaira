    ...
    <div className="bg-white w-full min-h-screen">
      ...
      <div className="p-6 bg-white mr-5 ml-5">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-xl font-bold mb-2">Ikuti Kelas E-Learning sekarang!</h1>
            <p className="text-gray-600">
              Jangan lewatkan kesempatan untuk mengikuti pelatihan dan temukan
              <br /> solusi cerdas bagi tambak kalian! Pilih kelas sesuai dengan minatmu
              <br /> dan optimalkan hasil panen dengan teknologi terkini
            </p>
          </div>
        </div>
