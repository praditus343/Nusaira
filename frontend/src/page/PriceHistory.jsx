...
const PriceCard = ({ supplier, location, price, isMain,province }) => (
    <div className="p-4 bg-blue-200 rounded-lg shadow-sm flex items-center justify-between ">
        <div className="flex flex-col w-full">
            ...
            <div className="flex gap-2">
                <button className="px-4 py-2 text-blue-500 border-2 border-blue-600 rounded-lg text-sm font-medium">
                    Lihat Kontak
                </button>
                <button className="px-4 py-2 text-white bg-blue-500 rounded-lg text-sm">
                    Lihat Detail
                </button>
            </div>
        </div>
