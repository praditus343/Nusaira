            ...
            <div className="flex space-x-4 w-max">
                ...
                <div className="bg-blue-600 rounded-lg p-4 flex justify-between items-center min-w-[400px] shadow-lg border-2 border-grey-300 transition-all duration-300">
                    <div className="flex-1">
                        ...
                        <button className="px-20 py-2 bg-blue-400 text-white rounded-md mt-5 hover:bg-blue-300 transition-colors duration-300 no-select">
                            Klik untuk info lebih lanjut
                        </button>
                    </div>
                    <div className="ml-4 no-select">
                        <img src={imgComputer} alt="Illustration" className="w-48 h-48 object-cover no-select" />
                    </div>
                </div>
                ...
                <div className="bg-blue-600 rounded-lg p-4 flex justify-between items-center min-w-[400px] shadow-lg border-2 border-grey-300 transition-all duration-300">
                    ...
                    <div className="flex-shrink-0 ml-4 no-select">
                        <img src={imgRead} alt="Illustration" className="w-48 h-48 object-cover no-select" />
                    </div>
                </div>
