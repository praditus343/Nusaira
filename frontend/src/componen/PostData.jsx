...
const AllPosts = [
  {
    ...
    content: `
      Usaha budidaya ikan lele merupakan salah satu sektor yang sangat menguntungkan dalam dunia perikanan. Ikan lele dikenal sebagai ikan yang cepat tumbuh dan mudah dibudidayakan. Dengan kebutuhan pasar yang terus meningkat, terutama di Indonesia, usaha ini menjadi peluang yang menjanjikan.
      ...
      Dengan pengelolaan yang baik, usaha budidaya ikan lele bisa memberikan keuntungan yang cukup besar, dan menjadi pilihan tepat bagi para petani ikan yang ingin memulai bisnis di bidang perikanan.
    `,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: `
      ...
      Meskipun tantangannya cukup besar, banyak peternak yang berhasil mengembangkan sistem aquaponik sebagai solusi yang menguntungkan dan berkelanjutan dalam budidaya ikan lele dan tanaman sekaligus. Inovasi ini membuka peluang baru bagi sektor pertanian dan perikanan di Indonesia.
    `,
  },
  {
    id: 5,
    ...
    content: `
      ...
      Dengan penerapan sistem aquaponik yang lebih luas, Indonesia dapat mengembangkan sektor perikanan dan pertanian yang lebih berkelanjutan, sekaligus memenuhi kebutuhan pangan masyarakat yang terus meningkat.
    `,
  },
  {
    id: 6,
    ...
    content: `
      Budidaya ikan di Indonesia memiliki potensi yang sangat besar, baik di sektor konsumsi domestik maupun ekspor. Negara ini memiliki sumber daya alam yang melimpah, seperti perairan yang luas dan berbagai jenis ikan yang cocok untuk dibudidayakan. Salah satu ikan yang paling banyak dibudidayakan di Indonesia adalah ikan lele, yang tidak hanya cepat tumbuh tetapi juga memiliki rasa yang lezat, membuatnya menjadi pilihan populer di pasar lokal.
      ...
      Dengan memanfaatkan potensi alam yang ada dan teknologi yang tepat, budidaya ikan di Indonesia tidak hanya bisa memenuhi kebutuhan domestik tetapi juga berpeluang menjadi sektor ekspor yang menjanjikan.
    `,
  },
  {
    id: 7,
    ...
    content: `
      Kolam terpal untuk budidaya ikan lele kini semakin diminati oleh peternak di Indonesia karena harganya yang lebih terjangkau dan fleksibilitas dalam penggunaannya. Kolam terpal memiliki beberapa keunggulan dibandingkan kolam beton atau kolam tanah, di antaranya kemudahan dalam pembuatan, biaya yang lebih rendah, dan kemampuan untuk dipindahkan sesuai dengan kebutuhan.
      ...
      Inovasi dalam penggunaan kolam terpal ini menunjukkan bagaimana teknologi sederhana dapat digunakan untuk meningkatkan produktivitas dalam budidaya ikan lele, membuka peluang bagi peternak dengan anggaran terbatas untuk mengembangkan usaha mereka secara lebih efisien.
    `,
  }
];
